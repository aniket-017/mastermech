...
<div>
      ...
      <form onSubmit={handleFilterSubmit}>
        ...
        <div className="select">
          ...
          <select className="select-box" value={specifiedStandard} onChange={(e) => setSpecifiedStandard(e.target.value)}>
        ...
        <div className="select">
          ...
          <select className="select-box" value={certificationStatus} onChange={(e) => setCertificationStatus(e.target.value)}>
            <option value="">Select</option>
...
<div className="select">
  ...
  <input type="number" className="select-box" value={mildSteelGrade[0]} onChange={(e) => setMildSteelGrade([parseInt(e.target.value), mildSteelGrade[1]])} />
  <input type="number" className="select-box" value={mildSteelGrade[1]} onChange={(e) => setMildSteelGrade([mildSteelGrade[0], parseInt(e.target.value)])} />
</div>
<div className="select">
  <label className="label">Alloy Steel Grade:</label>
  <input type="number" className="select-box" value={alloySteelGrade[0]} onChange={(e) => setAlloySteelGrade([parseInt(e.target.value), alloySteelGrade[1]])} />
  <input type="number" className="select-box" value={alloySteelGrade[1]} onChange={(e) => setAlloySteelGrade([alloySteelGrade[0], parseInt(e.target.value)])} />
</div>
